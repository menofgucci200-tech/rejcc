    ...
    <div class="mx-auto max-w-[1280px] px-8 py-8">
        ...
        <section>
            <div class="mb-4 flex flex-wrap items-end justify-between gap-4">
                ...
                <button type="button" class="btn-tap rounded-[10px] bg-brand px-4 py-2 text-xs font-bold text-white shadow-sm hover:bg-brand/90 hover:shadow-md">Exporter en CSV</button>
            </div>
            <div class="rounded-[18px] border border-brand/10 bg-white px-5 shadow-[0_2px_8px_rgba(3,29,89,.05)]">
                @forelse ($abonnes as $a)
                    <div class="row-hover -mx-5 flex items-center gap-4 border-t border-[#EDF0F5] px-5 py-3.5 first:border-t-0">
