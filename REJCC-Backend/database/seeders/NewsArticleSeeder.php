    ...
    public function run(): void
    {
        $articles = [
            [
                ...
                'excerpt' => "Une cohorte de porteurs de projets rejoint le réseau pour un parcours d'accompagnement inédit.",
                'body' => [
            ...
            [
                ...
                'reading_time' => '4 min',
                'author' => 'La rédaction REJCC',
                'excerpt' => 'Soixante mentors expérimentés accompagnent désormais les jeunes entreprises du réseau.',
                'body' => [
            ...
            [
                ...
                'reading_time' => '2 min',
                'author' => 'La rédaction REJCC',
                'excerpt' => "Le REJCC s'associe à des acteurs financiers pour soutenir les projets à fort impact.",
                'body' => [
            ...
            [
                ...
                'reading_time' => '3 min',
                'author' => 'La rédaction REJCC',
                'excerpt' => 'Une journée riche en rencontres, en pitchs et en inspiration pour les membres du réseau.',
                'body' => [
            ...
            [
                ...
                'reading_time' => '2 min',
                'author' => 'La rédaction REJCC',
                'excerpt' => 'Développement web, IA, cybersécurité : montez en compétences avec le REJCC.',
                'body' => [
            ...
            [
                ...
                'reading_time' => '4 min',
                'author' => 'La rédaction REJCC',
                'excerpt' => "Foi, excellence et entrepreneuriat : la force d'un réseau qui partage des valeurs.",
                'body' => [
        ...
        foreach ($articles as $a) {
            NewsArticle::updateOrCreate(['slug' => $a['slug']], $a);
        }
    }
}
